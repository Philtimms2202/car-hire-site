...
export async function generateMetadata({
  ...
  return {
    title: `Cheap Flights to ${hub.city}${primaryIata} | Compare Deals`,
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-teal-50 max-w-xl mx-auto mb-8 leading-relaxed font-light">
                Sorted your flight? We can also help you find hotels in {hub.city}, from budget stays to boutique picks, with city
