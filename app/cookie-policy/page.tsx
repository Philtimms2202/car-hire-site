...
// URL: hirecarhub.com/cookie-policy
// ============================================
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 leading-8 mb-8">
            This Cookie Policy explains what cookies are, how Hire Car Hub uses them and what choices you have regarding their use. By continuing to use our website, you consent to our use of cookies as described in this policy.
          </p>
          ...
          <p className="text-gray-600 leading-8 mb-4">
            Hire Car Hub uses cookies for the following purposes:
          </p>
          <ul className="list-disc list-inside text-gray-600 leading-8 mb-6">
            ...
            <li>To track referrals from affiliate partners and record commission where applicable</li>
          ...
          <p className="text-gray-600 leading-8 mb-6">
            When you click through to a car hire supplier via our website, affiliate cookies may be set to track whether a booking was made. This allows us to receive a commission from the supplier at no extra cost to you. These cookies do not store any personal payment information.
          </p>

          <h3 className="text-xl font-bold mt-6 mb-3" style={{color: '#2f797c'}}>Preference Cookies</h3>
          <p className="text-gray-600 leading-8 mb-6">
            These cookies remember choices you make on our website, such as your preferred language or region, so we can provide a more personalised experience on your return visits.
          </p>

          <h2 className="text-2xl font-bold mt-10 mb-4" style={{color: '#232e4e'}}>4. Third Party Cookies</h2>
          <p className="text-gray-600 leading-8 mb-6">
            Some cookies on our site are set by third party services that appear on our pages. These may include analytics providers, affiliate networks and car hire booking platforms. We do not control these cookies and recommend you check the relevant third party privacy and cookie policies for more information.
          </p>
          ...
          <p className="text-gray-600 leading-8 mb-6">
            If you have any questions about how we use cookies, please contact us at hello@hirecarhub.com or visit our <a href="/contact" style={{color: '#2f797c'}} className="underline hover:opacity-75">Contact Us</a> page.
          </p>
