  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section style={{backgroundColor: '#232e4e'}} className="text-white py-24 px-6 text-center">
        ...
        <p className="text-xl mb-10 text-gray-300">Thousands of experiences for you to enjoy - Instant results at the best price!</p>
...
<section className="py-16 px-6 bg-gray-50">
  <div className="max-w-6xl mx-auto">
    ...
    <p className="text-center text-gray-500 mb-10">
      Some of our most searched car hire locations
    </p>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {[
        ...
        { city: 'Dubai', emoji: '✈️', continent: 'asia', country: 'united-arab-emirates', slug: 'dubai' },
        { city: 'New York', emoji: '🗽', continent: 'north-america', country: 'united-states', slug: 'new-york' },
        { city: 'Orlando', emoji: '🎢', continent: 'north-america', country: 'united-states', slug: 'orlando' },
        { city: 'Sydney', emoji: '🦘', continent: 'australia', country: 'australia', slug: 'sydney' },
      ].map((dest) => (
        <a
          key={dest.city}
