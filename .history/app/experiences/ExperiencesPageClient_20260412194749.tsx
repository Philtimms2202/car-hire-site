...
const buildGygUrl = (path: string) =>
  `${GYG_BASE}${path}/?partner_id=${GYG_PARTNER_ID}`
...
const whyItems = [
  { emoji: '🎟️', title: 'Skip the Queues',    body: "Priority access on the world's most popular attractions — no waiting around." },
    ...
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        <p className="text-xl mb-10 text-gray-300 max-w-2xl mx-auto">
          Hand-picked tours, activities and adventures from the world's leading experiences platform — powered by GetYourGuide.
        </p>
        ...
        <div className="mt-8 flex justify-center gap-8 flex-wrap text-gray-400 text-sm">
          <span>✓ Free cancellation on most</span>
      ...
      {/* ── GYG PARTNER BANNER ── */}
      <div
        className="text-white text-sm text-center py-3 px-4 font-medium"
