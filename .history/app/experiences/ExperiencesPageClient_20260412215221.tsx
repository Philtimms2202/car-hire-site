        ...
        <div className="flex justify-center gap-6 mb-8">
          {(['flights','hotels','experiences','cars'] as const).map(tab => (
            <button key={tab} onClick={() => setActiveTab(tab)}
              className={`pb-2 text-lg font-medium transition-colors ${activeTab === tab ? 'border-b-2 border-white' : 'text-gray-400'}`}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6 max-w-xl">
            <div className="relative flex-1">
              <span className="absolute inset-y-0 left-6 flex items-center text-gray-400 pointer-events-none text-sm">🔍</span>
              <input
                type="text"
