...
export default function ExperiencesPage() {
  ...
  const handleTabClick = (tab: 'flights' | 'hotels' | 'experiences' | 'cars') => {
    ...
    else if (tab === 'cars')   router.push('/car-hire')
    else setActiveTab(tab) // 'experiences' — stay on this page
  }
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden text-white" style={{ backgroundColor: '#232e4e', minHeight: '520px' }}>
      ...
      <section className="py-20 px-6 text-center text-white" style={{ backgroundColor: '#232e4e' }}>
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          ...
          <a href="/" className="border border-white text-white font-semibold px-8 py-4 rounded-full hover:bg-white hover:text-gray-900 transition-colors text-sm">
