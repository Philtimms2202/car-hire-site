...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    badge: 'Must-Do',
    image: 'https://images.unsplash.com/photo-1503177119275-0aa32b3a9368?q=80&w=1740&auto=format&fit=crop',
...
// -----------------------------
// DYNAMIC EXPERIENCE SEARCH
// Builds a live GYG affiliate URL from the typed query
// -----------------------------
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      <input
        ...
        onKeyDown={handleKey}
        placeholder="Search a city, landmark or activity…"
        className="flex-1 px-4 py-3 rounded-lg border border-gray-300 shadow-sm text-black bg-white focus:outline-none focus:ring-2 focus:ring-blue-200 transition"
      />
      <a
        href={query.trim() ? buildGygSearchUrl(query) : `${GYG_BASE}/?partner_id=${GYG_PARTNER_ID}`}
        target="_blank"
        rel="noopener noreferrer sponsored"
        className="flex items-center justify-center px-6 py-3 rounded-lg text-white text-sm font-semibold transition-opacity hover:opacity-90 whitespace-nowrap"
...
export default function ExperiencesPage() {
  ...
  const handleGridSearchKey = (e: React.KeyboardEvent<HTMLInputElement>) => {
