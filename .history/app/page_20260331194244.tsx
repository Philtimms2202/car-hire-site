...
export default function Home() {
  ...
  const handleHotelSearch = () => {
    alert("Hotel search coming soon");
  };

  const handleExperienceSearch = () => {
    alert("Experience search coming soon");
  };
  ...
  return (
    <main className="min-h-screen bg-white p-6">
      ...
      <div className="mb-4">
        <label className="block mb-1 font-medium">Where are you going?</label>
        <input
          type="text"
