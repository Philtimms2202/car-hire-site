...
export default function About() {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        'From a weekend city break to a month-long road trip, we have got you covered in over 100 countries worldwide. City, coast or countryside — we've got it.',
    },
    {
      emoji: '⚡',
  ...
  const howItWorks = [
    {
      ...
      description:
        'Browse over 1,000 destinations across 100+ countries. Whether you know exactly where you are going or you are looking for inspiration, we've got you covered.',
    },
    {
      step: '02',
