...
export const metadata = {
  ...
  description: "We operate in over 100 countries worldwide to help you find flights, hotels, and more.",
  icons: {
    icon: "/favicon.ico",
  },
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-2" style={{color: '#232e4e'}}>Why Choose Timms Travel?</h2>
      ...
      <section style={{backgroundColor: '#232e4e'}} className="py-16 px-6 text-center text-white">
        <h2 className="text-3xl font-bold mb-4">Ready to Find Your Trip?</h2>
        <p className="text-gray-300 mb-8 text-lg">Search thousands of deals worldwide.</p>
        <a href="/locations/continents" className="btn-primary inline-block">Search Locations Now</a>
      </section>
