  ...
  const values = [
    {
      ...
      description:
        'We compare hundreds of destinations, allowing you to shop flights, hotels, experiences, and more from trusted suppliers so you don't have to. Find the best price in seconds.',
    },
    {
      emoji: '💬',
    ...
    },
    {
      ...
      description:
        'From a weekend city break to a month-long road trip, we've got you covered in over 100 countries worldwide. City, coast or countryside — we've got it.',
    },
    {
      emoji: '⚡',
      title: 'Instant Results',
      description:
        'No waiting around. Our search pulls up live availability and pricing in real time so you can book with confidence, knowing you're seeing the latest deals.',
    },
    {
      emoji: '💰',
      title: 'No Added Fees',
  ...
  const howItWorks = [
    {
      ...
      description:
        'Browse over 1,000 destinations across 100+ countries. Whether you know exactly where you're going or you're looking for inspiration, we've got you covered.',
    },
    {
      step: '02',
    ...
    },
    {
      ...
      description:
        'When you're ready, you'll be securely redirected to our partner's site to complete your booking. All payments are handled by them using secure, encrypted systems.',
    },
    {
      step: '04',
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-5 text-gray-600 leading-relaxed text-lg">
            ...
            <p>
              Whether you're planning a weekend city break, a family holiday, a honeymoon or a solo
