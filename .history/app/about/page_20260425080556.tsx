...
export default function About() {
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description:
        'When you are ready, you will be securely redirected to our partner's site to complete your booking. All payments are handled by them using secure, encrypted systems.',
    },
    {
      step: '04',
