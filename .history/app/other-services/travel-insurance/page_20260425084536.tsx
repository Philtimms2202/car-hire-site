...
export function generateMetadata() {
  return buildMetadata({
    title: 'Comprehensive Travel Insurance | Timms Travel',
    description:
    ...
    openGraph: {
      url: 'https://timmstravel.com/other-services/travel-insurance',
    },
    alternates: {
      canonical: 'https://timmstravel.com/other-services/travel-insurance',
    },
  })
}
