...
function AviasalesWidget({ destination, destinationName }) {
  ...
  useEffect(() => {
    ...
    script.src = `//www.travelpayouts.com/weedle/widget.js?marker=714930&host=www.aviasales.com&locale=en&currency=gbp&destination=${destination}&destination_name=${encodeURIComponent(destinationName)}`
    script.async = true
