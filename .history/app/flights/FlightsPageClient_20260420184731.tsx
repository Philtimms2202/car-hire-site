...
const allDestinationsIndex = [
  ...
  { label: 'Flights to Cape Verde',  href: '/locations/africa/cape-verde/sal' }, // see note below
  { label: 'Flights to Dubai',       href: '/locations/asia/united-arab-emirates/dubai' },
  { label: 'Flights to Dublin',      href: '/locations/europe/ireland/dublin' },
  { label: 'Flights to Ibiza',       href: '/locations/europe/spain/ibiza' },
  ...
  { label: 'Flights to Los Angeles', href: '/locations/north-america/united-states/los-angeles' },
  { label: 'Flights to Marrakech',   href: '/locations/africa/morocco/marrakech' },
  { label: 'Flights to New York',    href: '/locations/north-america/united-states/new-york' },
  { label: 'Flights to Orlando',     href: '/locations/north-america/united-states/orlando' },
