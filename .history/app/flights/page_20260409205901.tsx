...
function AviasalesWidget({ destination, destinationName }: { destination: string; destinationName: string }) {
  ...
  useEffect(() => {
    ...
    script.src = `//www.travelpayouts.com/weedle/widget.js?marker=714930&host=wwwaviasales.com&locale=en&currency=gbp&destination=${destination}&destination_name=${encodeURIComponent(destinationName)}`
    script.async = true
