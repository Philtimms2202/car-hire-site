...
export default function PopularRoutesClient({ regionGroups, totalRoutes }: Props) {
  ...
  const filtered = useMemo(() => {
    ...
    return regionGroups
      .filter(r => !activeRegion || r.continent === activeRegion)
      .map(r => ({
        ...r,
        origins: r.origins
          .map(o => ({
        ...
        <div className="max-w-lg mx-auto mt-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-4 rounded-2xl text-white-900 text-base shadow-xl focus:outline-none focus:ring-2"
