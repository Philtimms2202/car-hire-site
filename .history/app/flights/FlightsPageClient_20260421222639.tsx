...
const featuredDestinations: Destination[] = [
  {
    ...
    description: 'Cheap flights to London from UK airports',
  },
  {
    city: 'Barcelona',
    iata: 'BCN',
    ...
    continent: 'europe',
    country: 'spain',
    description: 'Cheap flights to Barcelona, Spain',
  },
  {
    city: 'New York',
    iata: 'JFK',
    ...
    country: 'usa',
    description: 'Cheap flights to New York, USA',
  },
  {
    city: 'Paris',
    iata: 'PAR',
    ...
    continent: 'europe',
    country: 'france',
    description: 'Cheap flights to Paris, France',
  },
  {
    city: 'Dubai',
    iata: 'DXB',
    ...
    country: 'uae',
    description: 'Cheap flights to Dubai, UAE',
  },
  {
    city: 'Orlando',
    iata: 'MCO',
    ...
    continent: 'north-america',
    country: 'usa',
    description: 'Cheap flights to Orlando, Florida',
  },
]
      ...
      <main className="min-h-screen bg-white" id="main-content">
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            {/* ── SEARCH WIDGET ── */}
            <div className="bg-white rounded-2xl p-6 max-w-10xl mx-auto shadow-xl text-black" role="search" aria-label="Flight and travel search">
