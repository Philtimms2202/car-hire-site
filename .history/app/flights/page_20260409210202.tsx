...
// Aviasales Popular Routes Widget
function AviasalesWidget({ destination, destinationName }) {
  const ref = useRef(null)

  useEffect(() => {
    if (!ref.current) return
    const script = document.createElement('script')
    script.src = `//www.travelpayouts.com/weedle/widget.js?marker=714930&host=www.aviasales.com&locale=en&currency=gbp&origin=MAN&origin_name=Manchester&destination=${destination}&destination_name=${encodeURIComponent(destinationName)}`
    script.async = true
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-500 mb-10">
            Hand‑picked routes with live prices from Aviasales
          </p>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Live deals · via Aviasales</p>
                  </div>
                </div>
