...
function AviasalesWidget({ origin = "MAN", destination }) {
  ...
  useEffect(() => {
    ...
    script.src = `https://www.travelpayouts.com/widgets/3b9b5b9b9b.js?marker=714930&origin=${origin}&destination=${destination}&currency=gbp&locale=en`
    script.async = true
