...
const allDestinationsIndex = [
  { label: 'Flights to Amsterdam',  href: '/destinations/amsterdam'  },
  { label: 'Flights to Antalya',    href: '/destinations/antalya'    },
  { label: 'Flights to Bangkok',    href: '/destinations/bangkok'    },
  { label: 'Flights to Barcelona',  href: '/destinations/barcelona'  },
  { label: 'Flights to Budapest',   href: '/destinations/budapest'   },
  { label: 'Flights to Cairo',      href: '/destinations/cairo'      },
  { label: 'Flights to Cape Town',  href: '/destinations/cape-town'  },
  { label: 'Flights to Cape Verde', href: '/destinations/cape-verde' },
  { label: 'Flights to Dubai',      href: '/destinations/dubai'      },
  { label: 'Flights to Dublin',     href: '/destinations/dublin'     },
  { label: 'Flights to Ibiza',      href: '/destinations/ibiza'      },
  { label: 'Flights to Istanbul',   href: '/destinations/istanbul'   },
  { label: 'Flights to Lisbon',     href: '/destinations/lisbon'     },
  { label: 'Flights to London',     href: '/destinations/london'     },
  { label: 'Flights to Los Angeles',href: '/destinations/los-angeles'},
  { label: 'Flights to Marrakech',  href: '/destinations/marrakech'  },
  { label: 'Flights to New York',   href: '/destinations/new-york'   },
  { label: 'Flights to Orlando',    href: '/destinations/orlando'    },
  { label: 'Flights to Paris',      href: '/destinations/paris'      },
  { label: 'Flights to Prague',     href: '/destinations/prague'     },
  { label: 'Flights to Rome',       href: '/destinations/rome'       },
  { label: 'Flights to Singapore',  href: '/destinations/singapore'  },
  { label: 'Flights to Sydney',     href: '/destinations/sydney'     },
  { label: 'Flights to Tenerife',   href: '/destinations/tenerife'   },
  { label: 'Flights to Tokyo',      href: '/destinations/tokyo'      },
]
