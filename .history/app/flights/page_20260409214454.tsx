  ...
  <div className="max-w-6xl mx-auto">
    ...
    {[
      ...
      },
      {
        ...
        items: [
          { city: "Dubai", iata: "DXB" },
          { city: "Tenerife", iata: "TCI" },
          { city: "Cape Verde", iata: "SID" },
        ]
      }
      ...
      <div key={season} className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((dest) => (
            <div
              key={dest.iata}
              className="bg-gray-50 rounded-2xl shadow-md p-5 hover:shadow-xl transition"
            >
              <p className="font-bold text-lg mb-2" style={{ color: '#232e4e' }}>
                {dest.city}
              </p>
