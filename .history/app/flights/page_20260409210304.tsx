...
function AviasalesWidget({ origin = "MAN", destination, destinationName }) {
  ...
  useEffect(() => {
    ...
    script.src = `https://www.travelpayouts.com/widgets/6b3b4f8b9c6b0a0c3b.js?marker=714930&origin=${origin}&destination=${destination}&currency=gbp&locale=en`
    script.async = true
