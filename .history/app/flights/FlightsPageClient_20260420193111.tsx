...
export const seasonalLocationsQuery = `
  *[_type == "location" && slug.current in $slugs]{
    city,
    "slug": slug.current,
    "country": countrySlug.current,
    "continent": continentSlug.current,
    emoji,
    airport
  }
`
                ...
                <li key={dest.iata} className="bg-white rounded-2xl shadow-md p-5 hover:shadow-xl transition">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <Link
                      href={`/locations/${dest.continents}/${dest.country}/${dest.slug}`}
