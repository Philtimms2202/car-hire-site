...
function AviasalesPopularRoutes({ origin = "MAN", destination }) {
  ...
  useEffect(() => {
    ...
    script.src = `https://www.travelpayouts.com/widgets/ea6b9b9b9b.js?marker=714930&origin=${origin}&destination=${destination}&currency=gbp&locale=en`
    script.async = true
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {destinations.map((dest) => (
              ...
              >
                ...
                <AviasalesPopularRoutes origin="MAN" destination={dest.iata} />
              </div>
            ))}
          </div>
        </div>
