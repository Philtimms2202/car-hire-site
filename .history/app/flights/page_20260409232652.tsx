  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        {/* SEARCH */}
        <div className="bg-white rounded-2xl p-6 max-w-4xl mx-auto shadow-xl text-black mb-8">
          <FlightSearch />
        </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-500 mb-6">
            Choose your departure airport above, then jump straight into live Kiwi.com results.
          </p>
