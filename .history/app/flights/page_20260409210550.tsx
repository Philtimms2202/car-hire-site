...
function AviasalesFeaturedDeals() {
  ...
  useEffect(() => {
    ...
    script.src =
      "https://tpemb.com/content?currency=gbp&trs=513651&shmarker=714930&target_host=www.aviasales.com%2Fsearch&locale=en&limit=6&powered_by=false&primary=%230085FF&promo_id=4044&campaign_id=100"
    script.async = true
