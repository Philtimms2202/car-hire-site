...
import HireCarSearch from '@/components/search/HireCarSearch'

export default function Home() {
  const [activeTab, setActiveTab] = useState<'experiences' | 'flights' | 'hotels' | 'hirecar'>('experiences')
      ...
      >
        ...
        <div className="bg-white rounded-2xl p-6 max-w-4xl mx-auto shadow-xl">
          ...
          <div className="mt-4">
            ...
            {activeTab === 'hirecar' && <HireCarSearch />}
          </div>
        </div>
