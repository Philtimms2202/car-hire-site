...
// Build a hotel type search URL
const expediaTypeUrl = (propertyType: string) =>
  `${EXPEDIA_BASE}/Hotel-Search?${EXPEDIA_AFFILIATE}&propertyType=${encodeURIComponent(propertyType)}`
