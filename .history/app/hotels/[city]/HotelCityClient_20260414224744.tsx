          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
              <thead className="bg-white">
                <tr>
                  <th className="p-3 text-left font-semibold" style={{ color: '#232e4e' }}>Area</th>
                  <th className="p-3 text-left font-semibold" style={{ color: '#232e4e' }}>Best for</th>
                  <th className="p-3 text-left font-semibold" style={{ color: '#232e4e' }}>Vibe</th>
                </tr>
              </thead>
              <tbody className="bg-white">
                {aiContent.neighbourhoods.map(n => (
                  <tr key={n.name} className="border-t border-gray-100">
                    ...
                    <td className="p-3 text-gray-600">Great for travellers who want…</td>
                    <td className="p-3 text-gray-600">{n.description.slice(0, 60)}…</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-14 px-6 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            {cityName} is divided into several distinct districts, each with its own character.
            Understanding the layout helps you choose the right base — whether you want nightlife,
            culture, food, shopping or a quieter residential feel.
          </p>
        </div>
      </section>
