...
const hotelCategories = [
  {
    ...
    image: "/images/hotels/top.jpg"
  },
  {
    label: "Luxury Hotels",
    params: { star: "5" },
    image: "/images/hotels/luxury.jpg"
  },
  {
    label: "Boutique Hotels",
    params: { propertyType: "BED_AND_BREAKFAST" },
    image: "/images/hotels/boutique.jpg"
  },
  {
    label: "Budget Hotels",
    params: { star: "3" },
  ...
  {
    label: "Apartments",
    params: { propertyType: "APART_HOTEL" },
    image: "/images/hotels/apartments.jpg"
  }
]

export function FeaturedHotels({ city }: { city: string }) {
  return (
      ...
      {hotelCategories.map(cat => {
        ...
        return (
          ...
          >
            ...
            />
            <div className="p-4">
              <h3 className="font-semibold text-lg">{cat.label} in {city}</h3>
...
function HotelTypeCard({ type }: { type: typeof hotelTypes[0] }) {
  // Use curated URL if available, otherwise fall back to dynamic builder
