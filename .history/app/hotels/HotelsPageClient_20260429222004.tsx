    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
      {cities.map(city => (
        <Link
          key={city.slug}
          href={`/hotels/${city.slug}`}
          className="group flex items-center justify-between px-5 py-4 rounded-2xl border border-gray-100 bg-white hover:border-teal-200 hover:bg-teal-50/30 transition-all"
        >
...
<section className="py-16 px-6 bg-gray-50">
  <div className="max-w-5xl mx-auto">
    ...
    <div className="mb-8">
      <p className="text-xs font-bold tracking-widest uppercase text-teal-600 mb-1">Browse by destination</p>
      <h2 className="text-2xl md:text-3xl font-bold" style={{ color: '#232e4e' }}>
        Popular destinations
      </h2>
      <p className="text-gray-400 text-sm mt-1">
        Explore our curated hotel guides for the most searched cities.
      </p>
    </div>
