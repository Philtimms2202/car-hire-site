...
<section className="py-16 px-6 bg-gray-50">
  <div className="max-w-5xl mx-auto">
    ...
    <div className="text-center mb-8">
      <p className="text-xs font-bold tracking-widest uppercase text-teal-600 mb-1">Find your stay</p>
      <h2 className="text-2xl md:text-3xl font-bold mb-2" style={{ color: '#232e4e' }}>
        Search hotels in any city
      </h2>
      <p className="text-gray-400 text-sm max-w-md mx-auto">
        Type a destination below and head straight to live prices and availability on Expedia.
      </p>
    </div>
    ...
    <div className="text-center">
      <a
        ...
        style={{ backgroundColor: '#03989e' }}
      >
        Search hotels in {selectedCity.city} on Expedia →
      </a>
      <p className="text-xs text-gray-400 mt-3">
        Live prices · No booking fees · Thousands of properties
      </p>
    </div>
