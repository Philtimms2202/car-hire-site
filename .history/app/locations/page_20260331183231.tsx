...
const allDestinations = [...ukDestinations, ...worldDestinations]
...
const continents = allDestinations.filter((dest) => {
  if (seen.has(dest.continent)) return false
  seen.add(dest.continent)
  return true
})
