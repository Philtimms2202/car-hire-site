    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 mb-10">
            From city breaks to coastal road trips, find the best car hire deals
            at airports and city centres across the UK.
          </p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 mb-10">
            Heading further afield? We compare car hire deals in over 100
            countries so you can hit the road wherever you land.
          </p>
