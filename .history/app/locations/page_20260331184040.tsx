...
export default function Locations() {
  ...
  export default function const continents = [
    {
      name: "Europe",
      slug: "europe",
      emoji: "🌍",
      description:
        "From historic cities to scenic coastlines, Europe offers endless road trip possibilities across diverse cultures and landscapes.",
    },
    {
      name: "Asia",
      slug: "asia",
      emoji: "🌏",
      description:
        "A vast continent of ancient history, futuristic cities, and breathtaking natural wonders — perfect for long-distance adventures.",
    },
    {
      name: "Africa",
      slug: "africa",
      emoji: "🌍",
      description:
        "From deserts to rainforests, Africa’s landscapes and wildlife make it an unforgettable destination for explorers.",
    },
    {
      name: "North America",
      slug: "north-america",
      emoji: "🌎",
      description:
        "Iconic highways, national parks, and vibrant cities — North America is built for epic road trips.",
    },
    {
      name: "South America",
      slug: "south-america",
      emoji: "🌎",
      description:
        "A continent of dramatic mountains, lush jungles, and colourful cultures, ideal for adventurous travellers.",
    },
    {
      name: "Oceania",
      slug: "oceania",
      emoji: "🌏",
      description:
        "From Australia’s outback to New Zealand’s fjords, Oceania offers some of the world’s most unique driving experiences.",
    },
    {
      name: "Antarctica",
      slug: "antarctica",
      emoji: "❄️",
      description:
        "The most remote continent on Earth — not a driving destination, but an iconic part of the world’s geography.",
    },
  ];
