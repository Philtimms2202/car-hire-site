    ...
    return (
      <main className="min-h-screen bg-white">
        ...
        <div className="text-center py-24">
          <h1 className="text-3xl font-bold mb-4" style={{color: '#232e4e'}}>No Countries Found</h1>
    ...
    <main className="min-h-screen bg-white">
      ...
      <section style={{backgroundColor: '#232e4e'}} className="text-white py-20 px-6 text-center">
        ...
        <p className="text-xl text-gray-300 max-w-2xl mx-auto">
          Discover incredible experiences across {continentName}. Browse by country to find tours, activities and adventures waiting for you.
        </p>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-2" style={{color: '#232e4e'}}>Countries in {continentName}</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {countries.map((country: any) => (
              ...
              >
                ...
                <p className="font-semibold text-sm" style={{color: '#232e4e'}}>{country.country}</p>
                <p className="text-xs mt-1" style={{color: '#2f797c'}}>View cities</p>
              </a>
            ))}
          </div>
