  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      >
        ...
        {/* NEW: Country Facts */}
        <div className="mt-10 grid grid-cols-2 md:grid-cols-3 gap-6 max-w-3xl mx-auto text-left">
          <div>
          ...
          <div>
            <p className="text-gray-400 text-sm">ISO Code</p>
            <p className="font-semibold">{iso2}</p>
          </div>
        </div>
      </section>
