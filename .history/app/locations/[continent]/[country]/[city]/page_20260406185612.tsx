  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="p-6 rounded-xl shadow-md border border-gray-200 bg-white">
        ...
        <p className="text-gray-700 text-lg">{localTime}</p>
      </div>
      ...
      <div className="p-6 rounded-xl shadow-md border border-gray-200 bg-white">
        ...
        <p className="text-gray-700 text-lg">{info.currency}</p>
      </div>
      ...
      <div className="p-6 rounded-xl shadow-md border border-gray-200 bg-white">
        ...
        <p className="text-gray-700 text-lg">{info.languages}</p>
      </div>
