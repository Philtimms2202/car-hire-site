...
<section className="py-20 px-6 bg-white border-t border-gray-200">
  <div className="max-w-4xl mx-auto">
    ...
    <p className="text-gray-600 mb-10">
      Useful things to know before visiting {countryName}. These tips apply across the whole country and help make your trip smoother.
    </p>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          {countryName} uses <strong>{countryData.plugType}</strong> plugs. 
          A travel adapter may be required depending on where you're visiting from.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          People in {countryName} drive on the <strong>{countryData.drivingSide}</strong> side of the road.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          The national emergency number is <strong>{countryData.emergencyNumber}</strong>.
        </p>
      </div>
