...
{/* -----------------------------------------------------------------------
    COMPONENTS — place these ABOVE your page component (outside JSX return)
------------------------------------------------------------------------ */}
...
/* -----------------------------------------------------------------------
   FETCH EXTENDED FIELDS — add these to your GROQ projection in getCountryData
------------------------------------------------------------------------ */
...
/* -----------------------------------------------------------------------
   SECTIONS — paste these BETWEEN Travel Tips and FAQ
------------------------------------------------------------------------ */
