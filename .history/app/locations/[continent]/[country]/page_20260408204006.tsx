...
<section className="py-20 px-6 bg-white border-t border-gray-200">
  <div className="max-w-4xl mx-auto">
    ...
    <p className="text-gray-600 mb-8">
      Helpful things to know before visiting {countryName}. These general tips apply across the country and make planning your trip easier.
    </p>
    ...
    <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          {countryName} uses the <strong>{currency}</strong>. Card payments are widely accepted, but it’s useful to carry small cash for markets and local shops.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          The main languages spoken are <strong>{languages}</strong>. English is usually understood in major tourist areas.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          Public transport is reliable in major cities. For rural areas, renting a car can be the easiest way to explore.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          Spring and autumn offer comfortable weather and fewer crowds. Summers can be busy and hot depending on the region.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          {countryName} is generally safe for travellers. As with any destination, keep an eye on belongings in busy areas.
        </p>
      </div>
      ...
      <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-600">
          Learning a few basic phrases and respecting local customs goes a long way. People appreciate politeness and patience.
        </p>
      </div>
