        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-600">{capital} is the capital city.</p>
            </div>

            <div>
              <h3 className="font-semibold text-lg" style={{ color: '#232e4e' }}>
                What language is spoken in {countryName}?
              </h3>
              <p className="text-gray-600">The main languages are: {languages}.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">{countryName} uses the {currency}.</p>
            </div>

            <div>
              <h3 className="font-semibold text-lg" style={{ color: '#232e4e' }}>
                How many people live in {countryName}?
              </h3>
              <p className="text-gray-600">The population is approximately {population}.</p>
            </div>

            <div>
              <h3 className="font-semibold text-lg" style={{ color: '#232e4e' }}>
                What is the ISO country code for {countryName}?
              </h3>
              <p className="text-gray-600">The ISO2 code is {iso2}.</p>
            </div>
