  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-20 px-6 bg-white border-t border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 mb-10">
            Useful things to know before visiting {countryName}. These tips apply across the whole country.
          </p>

          <div className="grid md:grid-cols-2 gap-6">

            <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
              <h3 className="font-semibold text-lg mb-2" style={{ color: '#232e4e' }}>Power Plugs</h3>
              <p className="text-gray-600">
                {countryName} uses <strong>{plugType}</strong> plugs.
              </p>
            </div>

            <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
              <h3 className="font-semibold text-lg mb-2" style={{ color: '#232e4e' }}>Driving Side</h3>
              <p className="text-gray-600">
                People in {countryName} drive on the <strong>{drivingSide}</strong> side of the road.
              </p>
            </div>

            <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
              <h3 className="font-semibold text-lg mb-2" style={{ color: '#232e4e' }}>Emergency Number</h3>
              <p className="text-gray-600">
                The national emergency number is <strong>{emergencyNumber}</strong>.
              </p>
            </div>

            <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100">
              <h3 className="font-semibold text-lg mb-2" style={{ color: '#232e4e' }}>Tipping Culture</h3>
              <p className="text-gray-600">{tippingCulture}</p>
            </div>

            <div className="p-6 bg-gray-50 rounded-lg shadow-sm border border-gray-100 md:col-span-2">
              <h3 className="font-semibold text-lg mb-2" style={{ color: '#232e4e' }}>Visa Information</h3>
              <p className="text-gray-600">{visaInfo}</p>
            </div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-10 text-center" style={{ color: '#232e4e' }}>
