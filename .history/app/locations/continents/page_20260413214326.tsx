      ...
      <section className="py-20 px-6 bg-white border-t">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-10">
            Here are some of the most visited destinations across each continent — perfect for inspiration.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-10 text-left">
            ...
            <div>
              <h3 className="font-bold text-xl mb-2">Asia</h3>
              <ul className="text-gray-600 space-y-1">
                <li>• Tokyo, Japan</li>
            ...
            <div>
              <h3 className="font-bold text-xl mb-2">North America</h3>
              <ul className="text-gray-600 space-y-1">
