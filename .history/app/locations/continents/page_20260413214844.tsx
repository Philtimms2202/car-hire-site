        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/europe/france/paris
            </Link>
          </li>
          ...
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/europe/italy/rome
            </Link>
          </li>
          ...
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/europe/spain/barcelona
            </Link>
          </li>
        </ul>
      </div>
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/asia/japan/tokyo
            </Link>
          </li>
          ...
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/asia/thailand/bangkok
            </Link>
          </li>
          ...
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/asia/singapore/singapore
            </Link>
          </li>
        </ul>
      </div>
        ...
        <ul className="space-y-3">
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/north-america/usa/new-york
            </Link>
          </li>
          ...
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/north-america/usa/los-angeles
            </Link>
          </li>
          ...
          <li className="flex items-start gap-2">
            ...
            <Link
              ...
              className="text-[#2f797c] underline underline-offset-2 hover:opacity-70 transition"
            >
              https://timmstravel.com/locations/north-america/canada/toronto
            </Link>
          </li>
        </ul>
      </div>
