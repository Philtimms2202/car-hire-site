    ...
    <div ref={wrapperRef} className="relative max-w-xl mx-auto">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3.5 rounded-xl border border-gray-200 bg-white text-gray-800 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2f797c] focus:border-transparent shadow-sm"
        />
      </div>
