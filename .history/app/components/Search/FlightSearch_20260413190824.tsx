...
// Travelpayouts redirect — MUST double encode redirect_url
const encodedKiwiUrl = encodeURIComponent(kiwiUrl.toString())

const tpUrl = new URL('https://tp.media/click')
tpUrl.searchParams.set('marker', '714930')
tpUrl.searchParams.set('redirect_url', encodedKiwiUrl)
tpUrl.searchParams.set('sub_id', 'timmstravel_flights')

// DO NOT SET p — Kiwi does not use it
