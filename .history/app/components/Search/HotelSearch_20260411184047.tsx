...
// It must match the FIRST child's age in the FIRST room.
let firstAge = 5 // safe default
if (rooms[0].children > 0 && rooms[0].ages.length > 0) {
  firstAge = rooms[0].ages[0]
}
params.append("childAge1", String(firstAge))

// Number of rooms (required for children to populate)
