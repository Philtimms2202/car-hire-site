...
return (
  <div className="space-y-3 relative z-20">
    ...
    <div className="flex flex-col sm:flex-row items-stretch gap-3">
      ...
      {/* PASSENGERS */}
      <div className="relative flex-1 min-w-[200px]" ref={travellerRef}>
        <label className="block text-xs text-gray-500 mb-1 font-semibold uppercase tracking-wide">
          Passengers
        </label>
        ...
        {travellerOpen && (
          <div className="absolute left-0 top-full mt-2 bg-white border border-gray-200 rounded-2xl shadow-xl p-5 w-72 z-50">
      ...
      <div className="w-full sm:w-auto flex flex-col justify-end">
        <button
          ...
          className="w-full sm:w-auto px-8 py-3 rounded-xl text-white font-bold text-lg transition hover:opacity-90 whitespace-nowrap"
    ...
    <a
      ...
      className="px-8 py-2 rounded-xl font-semibold text-sm text-center transition border whitespace-nowrap hover:bg-gray-50 inline-block"
