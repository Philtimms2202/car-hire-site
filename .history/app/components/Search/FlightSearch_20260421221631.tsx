...
export default function FlightSearch() {
  ...
  const renderDropdown = (
    ...
    return (
        <div className="absolute left-0 right-0 md:min-w-[420px] z-30 bg-white border border-gray-200 rounded-xl shadow-xl mt-1 max-h-80 overflow-y-auto">        {results.map((a) => (
          <div
...
{/* TO */}<div className="absolute left-0 right-0 z-30 bg-white border border-gray-200 rounded-xl shadow-xl mt-1 max-h-72 overflow-y-auto"></div>
<div className="relative flex-[2] min-w-0">
  <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1 px-1">
    To
  </label>
