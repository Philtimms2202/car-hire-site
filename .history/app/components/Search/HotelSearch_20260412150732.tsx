...
export default function HotelSearch() {
  ...
  const handleSearch = () => {
    ...
    // ✅ CRITICAL FIX: children per room (Expedia-safe format)
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="relative" ref={travellerRef}>
            ...
            {!isMobile && travellerOpen && (
              <div className="absolute z-30 mt-2 w-80 bg-white border rounded-xl shadow-xl p-4 right-0">
                  ...
                  <div key={index} className="mb-4 border-b pb-3">
                    ...
                    <div className="flex justify-between mt-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() =>
                            updateRoom(index, 'children', Math.min(6, room.children + 1))
                          }
                        >
                          +
                        </button>
                ...
                <button
                  onClick={addRoom}
                  className="text-[#03989e] text-sm mb-3"
                >
                  + Add room
                </button>
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full bg-[#03989e] text-white py-3 rounded-lg"
            >
              Search hotels
            </button>
          </div>
