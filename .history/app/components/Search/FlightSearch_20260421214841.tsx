...
export default function FlightSearch() {
  ...
  const handleSearch = () => {
    ...
    // Passenger encoding (e.g. 211)
    const paxCode = `${adults}${children}${infants}`

    // TravelPayouts required format
    const flightSearch =
      `${selectedFrom.iata_code}${departFormatted}${selectedTo.iata_code}` +
    ...
    // 🚀 FULL REDIRECT (leave Next.js entirely)
