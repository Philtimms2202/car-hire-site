  ...
  return (
    <>
      ...
      <div className="bg-white rounded-2xl p-6 max-w-4xl mx-auto shadow-xl text-black">
        {activeTab === "experiences" && <ExperienceSearch defaultLocation={defaultCity} />}
        {activeTab === "flights" && <FlightSearch defaultLocation={defaultCity} />}
        {activeTab === "hotels" && <HotelSearch defaultLocation={defaultCity} />}
        {activeTab === "cars" && (
          <CarSearch
