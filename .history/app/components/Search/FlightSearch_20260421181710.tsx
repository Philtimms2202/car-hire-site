    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col lg:flex-row items-stretch gap-2">
        ...
        <div className="flex-[1.2] min-w-0">
          ...
          <input
            type="date"
            className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-[#03989e] focus:border-transparent"
            value={depart}
            min={today}
            onChange={(e) => {
        ...
        <div className="flex flex-col justify-end shrink-0">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-xl text-white text-sm font-bold transition hover:opacity-90 whitespace-nowrap"
