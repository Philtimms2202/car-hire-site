...
// Build the Kiwi deep link
const kiwiDeep = new URL('https://www.kiwi.com/deep')

// FROM — unchanged
kiwiDeep.searchParams.set('from', from)

// TO — now supports "anywhere" automatically
// If user selects "Search Everywhere", `to` will simply be "anywhere"
kiwiDeep.searchParams.set('to', to || 'anywhere')

// DEPARTURE DATE
// Accepts YYYY-MM-DD (including shifted dates from +/- buttons)
if (depart) {
...
kiwiDeep.searchParams.set('children', String(children))
kiwiDeep.searchParams.set('infants', String(infants))
...
// Final URL
const kiwiUrl = kiwiDeep.toString()
