...
interface Props {
  cityName: string
  /** Example: "paris-l16" or "belfast-l4427" */
  gygPath: string
}

export default function ThingsToDoSearch({ cityName, gygPath }: Props) {
  ...
  const cityLink = `https://www.getyourguide.com/${gygPath}/?partner_id=P7B7GRH&searchSource=7`
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto mt-10 px-4">
        <div className="flex flex-col gap-4 w-full">
          ...
          {/* Date Selector (styled nicely, visual only) */}
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="
                  ...
                  shadow-sm focus:ring-2 focus:ring-[#2f797c]
                "
              />
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-gray-50 mt-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10 text-center">
            <a
              href=https://www.getyourguide.com/s/?et=679993&psrc=widget&partner_id=P7B7GRH&utm_medium=travel_agent&currency=EUR&q=Belfast&queryMatch=all&widget=activities&wid=04c938e5-673d-5432-a7ed-20e970c8b5de&page_id=c0619dd4-6566-5c1c-b4ab-be50a069e654&visitor_id=E090A6309D13465AACDD5A5C6BD35B36
              target="_blank"
