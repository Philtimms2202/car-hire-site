...
export default function ThingsToDoSearch({ cityName, gygPath }: Props) {
  ...
  // Build deep link for GetYourGuide
  const baseUrl = `https://www.getyourguide.com/${gygPath}/`
  ...
  if (startDate) {
    deepLinkParams.set('date_from', startDate)
    deepLinkParams.set('date_to', endDate || startDate)
  }

  if (people) {
    deepLinkParams.set('adults', String(people))
  }

  const deepLink = `${baseUrl}?${deepLinkParams.toString()}`
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-10 text-center">
            <a
              ...
              "
            >
              Book with selected dates & people
            </a>
          </div>
        </div>
      </section>
