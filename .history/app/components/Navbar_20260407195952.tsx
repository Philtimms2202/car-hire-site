      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-8 items-center">
          ...
          <div
            className="relative"
            onMouseEnter={(e) => {
              const panel = e.currentTarget.querySelector('.mega-panel')
          ...
          >
            ...
            {/* DROPDOWN PANEL */}
            <div
              className="mega-panel absolute left-0 top-full mt-3 w-[600px]
              bg-white shadow-xl rounded-xl p-6 grid grid-cols-3 gap-6 z-50 border border-gray-200"
              style={{ display: 'none' }}
            >
              <div>
