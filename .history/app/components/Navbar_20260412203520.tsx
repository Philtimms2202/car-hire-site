    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href="/hotels" className="font-medium hover:opacity-75 transition" style={{ color: '#232e4e' }}>Hotels</a>
          <a href="/experiences" className="font-medium hover:opacity-75 transition" style={{ color: '#232e4e' }}>Experiences</a>
