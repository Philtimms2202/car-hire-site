...
export default function Navbar() {
  ...
  return (
    <nav
      className="px-6 py-4 relative z-50 overflow-visible"
...
<div className="relative group">
  ...
  <a
    href="/locations"
    className="font-medium flex items-center gap-1 cursor-pointer hover:opacity-75 transition relative z-50"
    style={{ color: '#232e4e' }}
  >
    Locations
