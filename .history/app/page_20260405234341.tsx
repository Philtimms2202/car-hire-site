...
export const metadata = {
    title: "Timms Travel – Discover Amazing Experiences Worldwide",
    description:
      "Find the best things to do, tours, attractions, and travel experiences across the world. Explore cities, countries, and continents with Timms Travel.",
  }
