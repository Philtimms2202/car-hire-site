export default function NotFound() {
  return (
    <main className="w-full min-h-screen font-sans bg-brand-dark text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <a
            href="/flights/london-to-new-york"
            className="p-4 border border-white/20 rounded-xl hover:bg-white/10 transition"
          >
            <div className="font-medium">London → New York</div>
          </a>

          <a
            href="/flights/manchester-to-dubai"
            className="p-4 border border-white/20 rounded-xl hover:bg-white/10 transition"
          >
          ...
          <a
            href="/flights/edinburgh-to-paris"
            className="p-4 border border-white/20 rounded-xl hover:bg-white/10 transition"
          >
          ...
          <a
            href="/flights/birmingham-to-tenerife"
            className="p-4 border border-white/20 rounded-xl hover:bg-white/10 transition"
          >
