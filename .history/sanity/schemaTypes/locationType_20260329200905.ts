...
export const locationType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'slug', title: 'City Slug', type: 'slug', options: { source: 'city' } }),
    defineField({ name: 'country', title: 'Country Name', type: 'string' }),
    defineField({ name: 'countrySlug', title: 'Country Slug', type: 'slug', options: { source: 'country' } }),
    defineField({ name: 'countryEmoji', title: 'Country Flag Emoji', type: 'string' }),
    defineField({ name: 'continent', title: 'Continent', type: 'string', options: { list: ['Europe', 'Asia', 'North America', 'South America', 'Africa', 'Middle East', 'Oceania'] } }),
    defineField({ name: 'continentSlug', title: 'Continent Slug', type: 'slug', options: { source: 'continent' } }),
